...
public class Canonicalizer {
            ...
            try {
                ...
                if (choice.equals("f") || choice.equals("F")) {
                    ...
                    while ((lineEq = bufferedReader.readLine()) != null) {
                        if (isValidInput(lineEq)) {
                            String res = transformEq(parseEq(lineEq));
                    ...
                    if (isValidInput(equation)) {
                        System.out.println(transformEq(parseEq(equation)));
                    } else {
                        System.out.println("This input is invalid.");
                    }
                } else {
    ...
    public static String transformEq(String equation) {
        return "";
    }
     ...
     */
    public static String parseEq(String equation) {
     ...
     */
    public static HashMap<String, Double> buildTermMap(String lineEq) {
        ...
        for (int i = 0; i < lineEq.length(); i++) {
             if (Character.isDigit(lineEq.charAt(i))) {
                ...
                Term signTerm = new Term(Double.valueOf(1.0 * sign), null);
